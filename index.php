...
<div class="container">
    <div id="controls" class="col-md-4 col-md-offset-4">
        ...
        <button id="hdd-remove-btn" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#modal" data-remote="modals/removeHDDWarning.html" class="btn btn-info btn-block">Festplatte sicher entfernen</button>
